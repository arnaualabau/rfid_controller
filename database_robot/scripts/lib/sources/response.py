    ...
    def list_to_section(self, data, field_list):
        ...
        for row in data:
            ...
            for i in range(0, len(message)):
                ...
                elif message[i] == "qr_section":
                    section.qr_section = str(row[i])
                elif message[i] == "map_path":
                    section.map_path = str(row[i])
                elif message[i] == "description":
                    section.description = str(row[i])
                elif message[i] == "id_shop":
                    section.id_shop = str(row[i])
                elif message[i] == "waypoint_path":
                    section.waypoint_path = str(row[i])
            res.append(section)
        return str(message), res
