...
class RFIDNavigationController:
    '''
    ...
    def start_rfid_cb(self, request):
        ...
        if not is_set_up:
            #return error
            pass
        #Start count and store readings and twisting
...
if __name__ == '__main__':
    ...
    try:
        RFIDNavigationController(rospy.get_name())
        rospy.spin()
        
    except Exception as e:
        rospy.logfatal('[RFIDNavigationController] RFID Navigation controller died')
